...
const (
	...
	TodoService_ListTask_FullMethodName     = "/todo.TodoService/ListTask"
)
...
type TodoServiceClient interface {
	...
	ListTask(ctx context.Context, in *ListTasksRequest, opts ...grpc.CallOption) (*ListTasksResponse, error)
}
...
func (c *todoServiceClient) ListTask(ctx context.Context, in *ListTasksRequest, opts ...grpc.CallOption) (*ListTasksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTasksResponse)
	err := c.cc.Invoke(ctx, TodoService_ListTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TodoServiceServer interface {
	...
	ListTask(context.Context, *ListTasksRequest) (*ListTasksResponse, error)
...
func (UnimplementedTodoServiceServer) ListTask(context.Context, *ListTasksRequest) (*ListTasksResponse, error) {
...
func _TodoService_ListTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TodoService_ListTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).ListTask(ctx, req.(*ListTasksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
